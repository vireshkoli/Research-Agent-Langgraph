...
class Settings(BaseSettings):
    ...
    # Per-visitor share of the daily pot. Without it one person can drain the
    # whole day's budget in a few minutes and every later visitor is refused.
    session_cap_usd: float = 0.05
